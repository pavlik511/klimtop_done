/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, d as renderComponent, m as maybeRenderHead } from '../astro.258d6d1c.mjs';
import 'html-escaper';
...
const $$Privacy = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Privacy;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "description": "Our privacy policy will help you understand what information is collected and how it is used.", "title": "Privacy policy \xB7 Stone" }, { "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<div class="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
    <div class="sm:pb:20 flex flex-col gap-4 pb-16 text-center">
      <h1 class="text-4xl font-medium tracking-tight sm:text-5xl">Privacy Policy</h1>
    ...
    <div>
      ...
      <h2 class="mb-6 mt-12 text-xl font-medium sm:text-2xl">1. Information We Collect</h2>
      <p class="mb-6">
      ...
      <h2 class="mb-6 mt-12 text-xl font-medium sm:text-2xl">2. How We Use Your Information</h2>
      <p class="mb-4">We may use your personal information for the following purposes:</p>
      <ul class="list-inside list-disc space-y-4">
        <li>
...
` })}`;
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/privacy.astro", void 0);

const $$file = "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/privacy.astro";
const $$url = "/privacy";
