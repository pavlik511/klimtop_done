...
const $$Heading = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Heading;
  return renderTemplate`${maybeRenderHead()}<section class="pt-16 sm:py-20 tracking-wide">
  <div class="mx-auto max-w-2xl px-4 text-center sm:px-6 lg:max-w-7xl lg:px-8">
    <div class="flex flex-col gap-4 sm:gap-6">
      <h1 class="text-4xl font-medium sm:text-5xl lg:text-6xl">O firmě</h1>
...
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/components/about/Heading.astro", void 0);
...
const $$Mission = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
    <div class="grid gap-16 lg:grid-cols-2 lg:gap-24 ">
      ...
      <div class="flex flex-col gap-10 justify-center items-sta">
        <!-- Mission description -->
        <div class="space-y-8 sm:space-y-12">
          ...
          <div class="space-y-6">
            <p class="text-primary-950/70 dark:text-primary-200/70 text-base sm:text-lg">
              ...
              posouvá kupředu, abychom vám poskytli špičkové služby v&nbsp;oblasti klimatizací a&nbsp;vytápění.
            </p>
            <p class="text-primary-950/70 dark:text-primary-200/70 text-base sm:text-lg">
              Pracujeme s&nbsp;renomovanými značkami, jako jsou Toshiba a&nbsp;LG, abychom vám přinesli
               nejlepší ve světě klimatizace a&nbsptepelných čerpadel. Naše zkušenosti a&nbsp;odbornost jsou zárukou
                kvalitního servisu a&nbsp;precizní montáže. Ať už potřebujete osvěžení nebo teplo, jsme tu pro vás&nbsp;s
                  moderním přístupem k&nbsp;technologiím.
            </p>
...
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/components/about/Mission.astro", void 0);
...
const $$Values = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="pb-16 sm:py-20 tracking-wide">
  <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
    <div class="flex flex-col gap-8 lg:gap-12">
      <h2 class="text-3xl font-medium sm:text-4xl underline decoration-red decoration-4 underline-offset-4">Naše hodnoty</h2>
...
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/components/about/Values.astro", void 0);
...
` })}`;
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/about.astro", void 0);

const $$file = "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/about.astro";
const $$url = "/about";
