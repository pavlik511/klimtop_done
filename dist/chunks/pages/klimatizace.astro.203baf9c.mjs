...
const $$Info = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="py-16 sm:py-20 tracking-wide">
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      <div class="grid gap-12 lg:grid-cols-3 lg:gap-8">
        <h2 class="text-3xl font-medium sm:text-4xl underline decoration-red decoration-4 underline-offset-4">Klimatizace</h2>
  ...
  <section class="pb-16 sm:py-20 tracking-wide">
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      <div class="grid gap-12 lg:grid-cols-3 lg:gap-8">
        <h2 class="text-3xl font-medium sm:text-4xl underline decoration-red decoration-4 underline-offset-4">Princip klimatizace
        </h2>
        <div class="flex flex-col items-start gap-8 sm:gap-10 lg:col-span-2">
          <p class="text-primary-950/70 dark:text-primary-200/70 text-base sm:text-lg">
          ...
          <h4 class="text-xl font-medium sm:text-2xl">Fyzikální proces klimatizace</h4>
          <p class="text-primary-950/70 dark:text-primary-200/70 text-base sm:text-lg">
          ...
          <img class="mx-auto duration-500 hover:scale-110 cursor-pointer py-10" width="" height="" src="/assets/klimatizaceObr.png" alt="obrázek principu klimatizace">
          <h4 class="text-xl font-medium sm:text-2xl">1. fáze – komprese</h4>
          <p class="text-primary-950/70 dark:text-primary-200/70 text-base sm:text-lg">
          ...
          <h4 class="text-xl font-medium sm:text-2xl">2. fáze – kondenzace (předávání tepla)</h4>
          <p class="text-primary-950/70 dark:text-primary-200/70 text-base sm:text-lg">
          ...
          <h4 class="text-xl font-medium sm:text-2xl">3. fáze – expanze (přijímání tepla)</h4>
          <p class="text-primary-950/70 dark:text-primary-200/70 text-base sm:text-lg">
          ...
          <h4 class="text-xl font-medium sm:text-2xl">4. fáze (1. fáze) – komprese</h4>
          <p class="text-primary-950/70 dark:text-primary-200/70 text-base sm:text-lg">
...
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/components/airconduct/Info.astro", void 0);
...
` })}`;
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/klimatizace.astro", void 0);

const $$file = "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/klimatizace.astro";
