...
`;
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="mt-auto bg-primary-500/10 dark:bg-primary-400/10 py-16 lg:mt-20 lg:py-20 tracking-wide" aria-labelledby="footer-heading">
    ...
    <div class="flex flex-col justify-between gap-12 sm:gap-16 lg:flex-row">
      ...
      <a href="/" class="focus-visible:outline-primary-950 dark:group-focus-visible:outline-primary-200 rounded-md focus-visible:outline focus-visible:outline-2">
        ...
        <p class="text-primary-950/70 dark:text-primary-200/70 text-base">
          ...
          <a href="mailto:jirout.pavel@gmail.com"><u>jirout.pavel@gmail.com</u></a>
        </p>
        
        <p id="current-year" class="text-primary-950/70 dark:text-primary-200/70 text-sm"> <span id="year"></span> © PP511</p>
      ...
      <div class="grid max-w-xl flex-1 grid-cols-1 gap-8 sm:grid-cols-1 text-center">
        ${bottomLinks.map((group) => renderTemplate`<div class="flex flex-col gap-4">
              <p${addAttribute(group.headerClass, "class")}>${group.header}</p>
...
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/components/layout/Footer.astro", void 0);
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header x-data="{ open: false }" class="transition" :class="{ 'bg-primary-500/10 dark:bg-primary-400/10': open, ' bg-primary-500/10 dark:bg-primary-950': !(open) }">
...
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/components/layout/Header.astro", void 0);
...
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/layouts/Layout.astro", void 0);
...
` })}`;
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/404.astro", void 0);

const $$file = "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/404.astro";
const $$url = "/404";
