...
const $$ContactForm = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 ">
    <div class="grid gap-12 lg:grid-cols-1 lg:gap-8">
      ...
      <div class="flex flex-col gap-4 sm:gap-6 items-center justify-center text-center">
        <h2 class="text-3xl font-medium sm:text-4xl underline decoration-red decoration-4 underline-offset-4">Dejte nám vědět – získejte více informací</h2>
        <p class="text-primary-950/70 dark:text-primary-200/70 max-w-lg text-lg sm:text-xl pt-8">
          Máte dotazy ohledně našich služeb montáže klimatizací a&nbsp;tepelných čerpadel značek LG a Toshiba? Rádi Vám poskytneme veškeré informace, které potřebujete. Stačí zaslat dotaz na e-mail nebo se spojit telefonicky a my se Vám ozveme co nejdříve.
        </p>
      </div>
...
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/components/contact/ContactForm.astro", void 0);

const $$Astro$1 = createAstro();
const $$ContactInfo = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$ContactInfo;
  return renderTemplate`${maybeRenderHead()}<section class="pb-16 sm:py-10 tracking-wide">
  <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
    <dl class="grid gap-6 lg:grid-cols-3">
      <!-- Address -->
      <div class="bg-red dark:bg-primary-400/10 rounded-3xl px-6 py-8 duration-500 hover:scale-105 cursor-pointer">
        ...
        <dd class="flex h-full flex-col justify-between gap-12">
          ...
          <div class=" text-base text-white">
            <p><strong>Ulice a čp.:</strong> Úhřetická Lhota 66</p>
            <p><strong>Město a PSČ:</strong> Pardubice, 53002</p>
          </div>
        </dd>
      </div>
      ...
      <div class="bg-red dark:bg-primary-400/10 rounded-3xl px-6 py-8 duration-500 hover:scale-105 cursor-pointer">
        ...
        <dd class="flex h-full flex-col justify-between gap-12">
          ...
          <p class="font-bold text-base  text-white">+420 777 024 576</p>
        </dd>
      </div>
      ...
      <div class="bg-red dark:bg-primary-400/10 rounded-3xl px-6 py-8 duration-500 hover:scale-105 cursor-pointer">
        ...
        <dd class="flex h-full flex-col justify-between gap-12">
          ...
          <p class="font-bold text-base text-white"><a href="mailto:jirout.pavel@gmail.com"><u>jirout.pavel@gmail.com</u></a></p>
        </dd>
      </div>
    </dl>
  </div>
</section>`;
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/components/contact/ContactInfo.astro", void 0);
...
` })}`;
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/contact.astro", void 0);

const $$file = "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/contact.astro";
const $$url = "/contact";
...
export { $$ContactForm as $, $$ContactInfo as a, contact as c };
