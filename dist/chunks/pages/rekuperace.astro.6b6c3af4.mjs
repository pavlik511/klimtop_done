    ...
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      <div class="grid gap-12 lg:grid-cols-3 lg:gap-8">
        ...
        <div class="flex flex-col items-start gap-8 sm:gap-10 lg:col-span-2">
          ...
          <img class="mx-auto duration-500 hover:scale-110 cursor-pointer" width="" height="" src="/assets/rekuperace.png" alt="obrázek principu rekuperace">
        </div>
...
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/components/rekuperace/Rekuperace.astro", void 0);
...
` })}`;
}, "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/rekuperace.astro", void 0);

const $$file = "G:/Programing/dev/Astro/klimtop/testikklimtop/src/pages/rekuperace.astro";
