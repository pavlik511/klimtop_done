...
const images = import.meta.glob("/src/assets/images/rekuperace/*.{jpg,jpeg,png,JPG}", { eager: true });
...
<div className="w-full xl:w-[60%] flex justify-between items-center mb-4">
      ...
      <div className="w-full xl:w-[70%] p-10 rounded-lg">
        <h3 className="text-2xl font-medium tracking-tight sm:text-2xl pb-5">Rekuperace</h3>
        <ImageGallery3
          items={galleryImages}
          showPlayButton={true}
